...
- `gh-versions-mcp`: GitHubリポジトリを指定すると、バージョン一覧を取得するMCPサーバー。新しいバージョンが出たばかりのメジャーバージョンだったりする場合には、それを使うか、一つ前のメジャーバージョンの最新版を使うか検討すべきとのインストラクションも含めてあり、LLMツールが妥当なバージョンを選定する手助けをします。
